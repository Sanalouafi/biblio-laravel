        ...
        <div class="container mx-auto flex flex-wrap pt-4 pb-12">
            ...
            <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
                <div class="bg-white rounded-3xl p-8 mb-5">
                    <h1 class="text-black text-3xl font-bold mb-10 text-center">Add new reservation</h1>
                    ...
                    <form method="POST" action="{{ route('reservations.store') }}" enctype="multipart/form-data"
                        ...
                        <div class="py-2 px-4 md:px-8">
                            ...
                            <div class="bg-gray-200 rounded py-2">
                                ...
                                <div class="mb-1 p-2">
                                    <label class="text-black " for="">Book Title:</label>
                                ...
                                <div class="mb-1 p-2">
                                    ...
                                    <input id="author" name="reservation_date" type="date" required
                                        class="w-full h-10 mt-5 px-2 py-1 lg:px-4 lg:py-2 text-gray-700 bg-gray-100 text-xs lg:text-sm border border-gray-300 rounded-lg focus:outline-none focus:bg-white">
                                </div>
                                <div class="mb-1 p-2">
                                    <label class="text-black" for="">Return date:</label>
                                    <input id="author" name="return_date" type="date" required
                                        class="w-full h-10 mt-5 px-2 py-1 lg:px-4 lg:py-2 text-gray-700 bg-gray-100 text-xs lg:text-sm border border-gray-300 rounded-lg focus:outline-none focus:bg-white">
                                </div>
                                <div class="mb-1 p-2">
                                    <label class="text-black" for="">Description:</label>

                                    <textarea name="description" id="" cols="30"
                                        rows="10"class="w-full h-10 mt-5 px-2 py-1 lg:px-4 lg:py-2 text-gray-700 bg-gray-100 text-xs lg:text-sm border border-gray-300 rounded-lg focus:outline-none focus:bg-white"></textarea>
                                </div>
